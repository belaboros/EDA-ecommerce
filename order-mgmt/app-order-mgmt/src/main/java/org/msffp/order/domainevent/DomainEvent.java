package org.msffp.order.domainevent;
...
public class DomainEvent {
    ...
    public static DomainEvent create(Order o) {
        return create(o, o.getStatus().name(), null);
    }

    public static DomainEvent create(Order o, String domainEventType, String customHeaders) {
        DomainEvent event = new DomainEvent(Long.toString(o.getId()));
        event.setAggregateType(Order.class.getSimpleName());
